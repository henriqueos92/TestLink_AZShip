...
$tlCfg->testcase_cfg->viewerFieldsOrder->summary = 1;
$tlCfg->testcase_cfg->viewerFieldsOrder->spaceOne = 2;
$tlCfg->testcase_cfg->viewerFieldsOrder->preconditions = 3;
 ...
 *
 */
$tlCfg->attachments->allowed_filenames_regexp = '/^[a-zA-Z0-9_-]{1,30}\.[a-zA-Z0-9]{1,10}$/';
